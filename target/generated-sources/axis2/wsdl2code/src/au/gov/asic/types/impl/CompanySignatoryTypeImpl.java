 ...
 */
public class CompanySignatoryTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements au.gov.asic.types.CompanySignatoryType
{
    
    public CompanySignatoryTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public au.gov.asic.types.CompanySignatoryType.Capacity.Enum getCapacity()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            return (au.gov.asic.types.CompanySignatoryType.Capacity.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public au.gov.asic.types.CompanySignatoryType.Capacity xgetCapacity()
    {
        synchronized (monitor())
        {
            check_orphaned();
            au.gov.asic.types.CompanySignatoryType.Capacity target = null;
            target = (au.gov.asic.types.CompanySignatoryType.Capacity)get_store().find_element_user(CAPACITY$2, 0);
            return target;
        }
    }
     ...
     */
    public void setCapacity(au.gov.asic.types.CompanySignatoryType.Capacity.Enum capacity)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetCapacity(au.gov.asic.types.CompanySignatoryType.Capacity capacity)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (au.gov.asic.types.CompanySignatoryType.Capacity)get_store().add_element_user(CAPACITY$2);
            }
            target.set(capacity);
        }
    }
     ...
     */
    public static class CapacityImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements au.gov.asic.types.CompanySignatoryType.Capacity
    {
