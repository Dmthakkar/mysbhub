 ...
 */
public class BirthDetailsExtTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements au.gov.asic.types.BirthDetailsExtType
{
    
    public BirthDetailsExtTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public au.gov.asic.types.BirthDetailsExtType.Date xgetDate()
    {
        synchronized (monitor())
        {
            check_orphaned();
            au.gov.asic.types.BirthDetailsExtType.Date target = null;
            target = (au.gov.asic.types.BirthDetailsExtType.Date)get_store().find_element_user(DATE$0, 0);
            return target;
        }
    }
     ...
     */
    public void xsetDate(au.gov.asic.types.BirthDetailsExtType.Date date)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (au.gov.asic.types.BirthDetailsExtType.Date)get_store().add_element_user(DATE$0);
            }
            target.set(date);
        }
    }
     ...
     */
    public au.gov.asic.types.BirthDetailsExtType.CityTown xgetCityTown()
    {
        synchronized (monitor())
        {
            check_orphaned();
            au.gov.asic.types.BirthDetailsExtType.CityTown target = null;
            target = (au.gov.asic.types.BirthDetailsExtType.CityTown)get_store().find_element_user(CITYTOWN$2, 0);
            return target;
        }
    }
     ...
     */
    public void xsetCityTown(au.gov.asic.types.BirthDetailsExtType.CityTown cityTown)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (au.gov.asic.types.BirthDetailsExtType.CityTown)get_store().add_element_user(CITYTOWN$2);
            }
            target.set(cityTown);
        }
    }
     ...
     */
    public au.gov.asic.types.BirthDetailsExtType.Iso3166CountryCode xgetIso3166CountryCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            au.gov.asic.types.BirthDetailsExtType.Iso3166CountryCode target = null;
            target = (au.gov.asic.types.BirthDetailsExtType.Iso3166CountryCode)get_store().find_element_user(ISO3166COUNTRYCODE$6, 0);
            return target;
        }
    }
     ...
     */
    public void xsetIso3166CountryCode(au.gov.asic.types.BirthDetailsExtType.Iso3166CountryCode iso3166CountryCode)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (au.gov.asic.types.BirthDetailsExtType.Iso3166CountryCode)get_store().add_element_user(ISO3166COUNTRYCODE$6);
            }
     ...
     */
    public au.gov.asic.types.BirthDetailsExtType.CountryOfBirth xgetCountryOfBirth()
    {
        synchronized (monitor())
        {
            check_orphaned();
            au.gov.asic.types.BirthDetailsExtType.CountryOfBirth target = null;
            target = (au.gov.asic.types.BirthDetailsExtType.CountryOfBirth)get_store().find_element_user(COUNTRYOFBIRTH$8, 0);
            return target;
        }
    }
     ...
     */
    public void xsetCountryOfBirth(au.gov.asic.types.BirthDetailsExtType.CountryOfBirth countryOfBirth)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (au.gov.asic.types.BirthDetailsExtType.CountryOfBirth)get_store().add_element_user(COUNTRYOFBIRTH$8);
            }
     ...
     */
    public static class DateImpl extends org.apache.xmlbeans.impl.values.JavaGDateHolderEx implements au.gov.asic.types.BirthDetailsExtType.Date
    {
     ...
     */
    public static class CityTownImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements au.gov.asic.types.BirthDetailsExtType.CityTown
    {
     ...
     */
    public static class Iso3166CountryCodeImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements au.gov.asic.types.BirthDetailsExtType.Iso3166CountryCode
    {
     ...
     */
    public static class CountryOfBirthImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements au.gov.asic.types.BirthDetailsExtType.CountryOfBirth
    {
