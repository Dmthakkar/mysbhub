 ...
 */
public class OrganisationTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements au.gov.asic.types.bn.OrganisationType
{
     ...
     */
    public au.gov.asic.types.bn.OrganisationType.Name xgetName()
    {
        synchronized (monitor())
        {
            check_orphaned();
            au.gov.asic.types.bn.OrganisationType.Name target = null;
            target = (au.gov.asic.types.bn.OrganisationType.Name)get_store().find_element_user(NAME$0, 0);
            return target;
        }
    }
     ...
     */
    public void xsetName(au.gov.asic.types.bn.OrganisationType.Name name)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (au.gov.asic.types.bn.OrganisationType.Name)get_store().add_element_user(NAME$0);
            }
            target.set(name);
        }
    }
    ...
    public au.gov.asic.types.AddressExtType getAddressArray(int i)
    {
        synchronized (monitor())
        {
            ...
            target = (au.gov.asic.types.AddressExtType)get_store().find_element_user(ADDRESS$6, i);
            if (target == null)
            {
    ...
    public au.gov.asic.types.AddressExtType insertNewAddress(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            au.gov.asic.types.AddressExtType target = null;
            target = (au.gov.asic.types.AddressExtType)get_store().insert_element_user(ADDRESS$6, i);
            return target;
        }
    }
     ...
     */
    public static class NameImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements au.gov.asic.types.bn.OrganisationType.Name
    {
