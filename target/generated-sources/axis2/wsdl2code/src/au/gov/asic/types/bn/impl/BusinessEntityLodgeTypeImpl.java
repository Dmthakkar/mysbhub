 ...
 */
public class BusinessEntityLodgeTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements au.gov.asic.types.bn.BusinessEntityLodgeType
{
    
    public BusinessEntityLodgeTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public au.gov.asic.types.bn.IndividualLodgeType getIndividual()
    {
        synchronized (monitor())
        {
            ...
            target = (au.gov.asic.types.bn.IndividualLodgeType)get_store().find_element_user(INDIVIDUAL$4, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setIndividual(au.gov.asic.types.bn.IndividualLodgeType individual)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (au.gov.asic.types.bn.IndividualLodgeType)get_store().add_element_user(INDIVIDUAL$4);
            }
    ...
    public au.gov.asic.types.bn.OrganisationLodgeType getOrganisation()
    {
        synchronized (monitor())
        {
            ...
            target = (au.gov.asic.types.bn.OrganisationLodgeType)get_store().find_element_user(ORGANISATION$6, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setOrganisation(au.gov.asic.types.bn.OrganisationLodgeType organisation)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (au.gov.asic.types.bn.OrganisationLodgeType)get_store().add_element_user(ORGANISATION$6);
            }
     ...
     */
    public au.gov.asic.types.bn.BusinessEntityLodgeType.OwnerType.Enum getOwnerType()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            return (au.gov.asic.types.bn.BusinessEntityLodgeType.OwnerType.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public au.gov.asic.types.bn.BusinessEntityLodgeType.OwnerType xgetOwnerType()
    {
        synchronized (monitor())
        {
            check_orphaned();
            au.gov.asic.types.bn.BusinessEntityLodgeType.OwnerType target = null;
            target = (au.gov.asic.types.bn.BusinessEntityLodgeType.OwnerType)get_store().find_element_user(OWNERTYPE$8, 0);
            return target;
        }
    }
     ...
     */
    public void setOwnerType(au.gov.asic.types.bn.BusinessEntityLodgeType.OwnerType.Enum ownerType)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetOwnerType(au.gov.asic.types.bn.BusinessEntityLodgeType.OwnerType ownerType)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (au.gov.asic.types.bn.BusinessEntityLodgeType.OwnerType)get_store().add_element_user(OWNERTYPE$8);
            }
     ...
     */
    public au.gov.asic.types.bn.AssociateLodgeType[] getAssociateArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            au.gov.asic.types.bn.AssociateLodgeType[] result = new au.gov.asic.types.bn.AssociateLodgeType[targetList.size()];
     ...
     */
    public au.gov.asic.types.bn.AssociateLodgeType getAssociateArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            au.gov.asic.types.bn.AssociateLodgeType target = null;
            target = (au.gov.asic.types.bn.AssociateLodgeType)get_store().find_element_user(ASSOCIATE$10, i);
            if (target == null)
            {
     ...
     */
    public void setAssociateArray(au.gov.asic.types.bn.AssociateLodgeType[] associateArray)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void setAssociateArray(int i, au.gov.asic.types.bn.AssociateLodgeType associate)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public au.gov.asic.types.bn.AssociateLodgeType insertNewAssociate(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            au.gov.asic.types.bn.AssociateLodgeType target = null;
            target = (au.gov.asic.types.bn.AssociateLodgeType)get_store().insert_element_user(ASSOCIATE$10, i);
            return target;
        }
    }
     ...
     */
    public au.gov.asic.types.bn.AssociateLodgeType addNewAssociate()
    {
        synchronized (monitor())
        {
            check_orphaned();
            au.gov.asic.types.bn.AssociateLodgeType target = null;
            target = (au.gov.asic.types.bn.AssociateLodgeType)get_store().add_element_user(ASSOCIATE$10);
            return target;
        }
    }
     ...
     */
    public static class OwnerTypeImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements au.gov.asic.types.bn.BusinessEntityLodgeType.OwnerType
    {
