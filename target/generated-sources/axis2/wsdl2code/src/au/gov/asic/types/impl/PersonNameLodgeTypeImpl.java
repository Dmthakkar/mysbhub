 ...
 */
public class PersonNameLodgeTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements au.gov.asic.types.PersonNameLodgeType
{
    
    public PersonNameLodgeTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public au.gov.asic.types.PersonNameLodgeType.GivenNames xgetGivenNames()
    {
        synchronized (monitor())
        {
            check_orphaned();
            au.gov.asic.types.PersonNameLodgeType.GivenNames target = null;
            target = (au.gov.asic.types.PersonNameLodgeType.GivenNames)get_store().find_element_user(GIVENNAMES$0, 0);
            return target;
        }
    }
     ...
     */
    public void xsetGivenNames(au.gov.asic.types.PersonNameLodgeType.GivenNames givenNames)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (au.gov.asic.types.PersonNameLodgeType.GivenNames)get_store().add_element_user(GIVENNAMES$0);
            }
     ...
     */
    public au.gov.asic.types.PersonNameLodgeType.OtherGivenNames xgetOtherGivenNames()
    {
        synchronized (monitor())
        {
            check_orphaned();
            au.gov.asic.types.PersonNameLodgeType.OtherGivenNames target = null;
            target = (au.gov.asic.types.PersonNameLodgeType.OtherGivenNames)get_store().find_element_user(OTHERGIVENNAMES$2, 0);
            return target;
        }
    }
     ...
     */
    public void xsetOtherGivenNames(au.gov.asic.types.PersonNameLodgeType.OtherGivenNames otherGivenNames)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (au.gov.asic.types.PersonNameLodgeType.OtherGivenNames)get_store().add_element_user(OTHERGIVENNAMES$2);
            }
     ...
     */
    public au.gov.asic.types.PersonNameLodgeType.FamilyName xgetFamilyName()
    {
        synchronized (monitor())
        {
            check_orphaned();
            au.gov.asic.types.PersonNameLodgeType.FamilyName target = null;
            target = (au.gov.asic.types.PersonNameLodgeType.FamilyName)get_store().find_element_user(FAMILYNAME$4, 0);
            return target;
        }
    }
     ...
     */
    public void xsetFamilyName(au.gov.asic.types.PersonNameLodgeType.FamilyName familyName)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (au.gov.asic.types.PersonNameLodgeType.FamilyName)get_store().add_element_user(FAMILYNAME$4);
            }
     ...
     */
    public static class GivenNamesImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements au.gov.asic.types.PersonNameLodgeType.GivenNames
    {
     ...
     */
    public static class OtherGivenNamesImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements au.gov.asic.types.PersonNameLodgeType.OtherGivenNames
    {
     ...
     */
    public static class FamilyNameImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements au.gov.asic.types.PersonNameLodgeType.FamilyName
    {
